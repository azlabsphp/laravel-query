...
class EloquentDMLQueryManagerTest extends TestCase
{
    ...
    public function testCreateWithParamsMethod()
    {
        $dmlManager = DMLManager(Person::class);
        $person = $dmlManager->create(
            [
    ...
    public function testCreateWithClosureMethod()
    {
        $dmlManager = DMLManager(Person::class);
        $person = $dmlManager->create(
            [
    ...
    public function testCreateUpsertMethod()
    {
        $dmlManager = DMLManager(Person::class);
        $dmlManager->create(
            [
    ...
    public function testCreateManyMethod()
    {
        $dmlManager = DMLManager(Person::class);
